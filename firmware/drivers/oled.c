...
static void oled_icon(uint8_t const icon[4][40]);
...
static const uint8_t oled_icon_cow_data[4][40] = {
...
static const uint8_t oled_icon_pig_data[4][40] = {
...
static const uint8_t oled_icon_sheep_data[4][40] = {
...
static const uint8_t oled_icon_duck_data[4][40] = {
...
static const uint8_t oled_icon_fish_data[4][40] = {
...
static const uint8_t oled_icon_egg_data[4][40] = {
...
static const uint8_t oled_icon_egg2_data[4][40] = {
...
static const uint8_t oled_icon_thermo_data[4][40] = {
...
{
    oled_icon(oled_icon_cow_data);
}

void oled_icon_pig(void)
{
    oled_icon(oled_icon_pig_data);
}

void oled_icon_sheep(void)
{
    oled_icon(oled_icon_sheep_data);
}

void oled_icon_duck(void)
{
    oled_icon(oled_icon_duck_data);
}

void oled_icon_fish(void)
{
    oled_icon(oled_icon_fish_data);
}

void oled_icon_egg(void)
{
    oled_icon(oled_icon_egg2_data);
}

void oled_icon_thermo(void)
{
    oled_icon(oled_icon_thermo_data);
}
